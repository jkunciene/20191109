...
<div class="row">
  <div class="col-12">
    ...
    <tr>
        ...
        <td bgcolor="#CCCCCC"><strong>Area</strong></td><td bgcolor="#CCCCCC"><strong>Population</strong></td><td bgcolor="#CCCCCC"><strong>Code</strong><td bgcolor="#CCCCCC"><strong>Date</strong></td></td><td bgcolor="#CCCCCC"><strong>Update</strong></td><td bgcolor="#CCCCCC"><strong>Delete</strong></td></tr>
    <?php
    $salys = getCountryZA();
